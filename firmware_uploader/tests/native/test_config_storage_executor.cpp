...
TEST(executor_sf_bw_defaults_on_erased_eeprom) {
...
TEST(executor_sf_bw_read_valid_values) {
  eeprom_reset_erased();
...
TEST(executor_sf_bw_invalid_values_fall_back_to_defaults) {
...
TEST(executor_sf_bw_addresses_do_not_overlap_ceiling_or_key) {
